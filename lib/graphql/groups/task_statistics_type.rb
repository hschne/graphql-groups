...
module GraphQL
  module Groups
    class TaskStatisticsType < BaseObject
      ...
      # contains the information about required aggregates (e.g. count, sum) and which groups (e.g. by section).
      # This conversion happens in order to provide a decoupling of GraphQL from the statistics collection logic.
